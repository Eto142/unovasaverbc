...
<html lang="en">
<head>
    <title>Verify Login — Unova Saver Bank Corporation</title>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        .brand-panel { background: radial-gradient(120% 140% at 0% 0%, #1c1f27 0%, #0b0c10 55%, #0b0c10 100%); }
        .dot-grid { background-image: radial-gradient(rgba(255,255,255,0.08) 1px, transparent 1px); background-size: 24px 24px; }
        .panel-glow { background: radial-gradient(60% 60% at 50% 40%, rgba(229,28,36,0.28), transparent 70%); filter: blur(10px); }
        .divider-dot::before { content: ""; display: inline-block; width: 3px; height: 3px; border-radius: 9999px; background: currentColor; margin: 0 0.65rem; vertical-align: middle; }
    </style>
</head>
...
<body class="font-sans bg-gray-50 text-gray-900">
    ...
    <div class="min-h-screen w-full flex">
        ...
        <div class="hidden lg:flex lg:w-[45%] xl:w-[42%] relative overflow-hidden brand-panel text-white flex-col justify-between p-12 xl:p-16">
            ...
            <div class="relative z-10">
                <h1 class="text-4xl xl:text-[2.75rem] font-extrabold leading-[1.15] tracking-tight text-white mb-4">
                    Two-factor<br>authentication.
                </h1>
                <p class="text-gray-400 text-base mb-10 max-w-sm">
                    Your account is protected with an extra layer of security. A one-time code was sent to your registered email.
                </p>

                <div class="space-y-5">
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center"><i data-lucide="shield-check" class="h-4 w-4 text-primary-400"></i></div>
                        <p class="text-white font-medium text-sm">Two-Factor Auth</p>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center"><i data-lucide="timer" class="h-4 w-4 text-secondary-400"></i></div>
                        <p class="text-white font-medium text-sm">10-Minute Expiry</p>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center"><i data-lucide="lock" class="h-4 w-4 text-primary-400"></i></div>
                        <p class="text-white font-medium text-sm">Phishing Protected</p>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center"><i data-lucide="key" class="h-4 w-4 text-secondary-400"></i></div>
                        <p class="text-white font-medium text-sm">One-Time Use Only</p>
                    </div>
                </div>
            </div>
