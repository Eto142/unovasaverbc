...
<html lang="en">
<head>
    <title>Create an Account - Unova Saver Bank Corporation</title>
    <meta charset="UTF-8">
        ...
        <div class="hidden lg:flex lg:w-[34%] xl:w-[30%] relative overflow-hidden brand-panel text-white flex-col justify-between p-12">
            ...
            <div class="relative z-10">
                <h1 class="text-3xl font-extrabold leading-tight tracking-tight text-white mb-4">
                    Start banking<br>with us today.
                </h1>
                <p class="text-gray-400 text-sm mb-10 max-w-xs">
                    Create your Unova Saver Bank Corporation account in a couple of minutes.
                </p>

                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center">
                            <i data-lucide="shield-check" class="h-4 w-4 text-primary-400"></i>
                        </div>
                        <div>
                            <p class="text-white font-medium text-sm">Secure by design</p>
                            <p class="text-gray-500 text-xs mt-0.5">Industry-leading protocols keep your funds safe</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center">
                        ...
                        <div>
                            <p class="text-white font-medium text-sm">Fast transfers</p>
                            <p class="text-gray-500 text-xs mt-0.5">Send and receive money in seconds</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center">
                            <i data-lucide="globe" class="h-4 w-4 text-primary-400"></i>
                        </div>
                        <div>
                            <p class="text-white font-medium text-sm">Access anywhere</p>
                            <p class="text-gray-500 text-xs mt-0.5">Manage your account 24/7, on any device</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div x-data="{
                    ...
                    <div class="px-8 py-6 border-b border-gray-100">
                        ...
                        <div class="flex justify-between mt-2 text-xs text-gray-500">
                            <div :class="{ 'text-primary-600 font-medium': step >= 1 }">Account Setup</div>
                    ...
                    <div class="px-8 py-6">
                        <form method="POST" action="{{route('register.custom')}}" id="regester" class="needs-validation" novalidate>
                            ...
                            <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                                <div class="mb-6">
                                    <h3 class="text-lg font-medium text-gray-900">Tell us about you</h3>
                                    <p class="mt-1 text-sm text-gray-500">We need a few details to set up your account.</p>
                                </div>
