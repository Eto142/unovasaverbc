...
<head>
    ...
    <title>Error {{ $exception->getStatusCode() ?? 'Error' }} | {{ config('app.name', 'unova saver') }}</title>
...
<body>
    <div class="error-card animate-in {{ $exception->getStatusCode() == 403 ? 'warning' : ($exception->getStatusCode() == 404 ? '' : 'error') }}">
        <!-- Company Logo -->
        <img src="logo.png" alt="unova saver" class="error-logo">
        ...
        <div class="error-actions">
            ...
            <a href="mailto:support@unovasaverbc.com" class="btn btn-outline">
                <i class="fas fa-envelope"></i> Contact Support
            </a>
        </div>
        
        <div class="error-footer">
            &copy; {{ date('Y') }} unova saver. All rights reserved.
        </div>
    </div>
</body>
</html>