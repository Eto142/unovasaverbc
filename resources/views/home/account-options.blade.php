...
<html lang="en">
<head>
    <title>Choose Account Type - Unova Saver Bank Corporation</title>
    <meta charset="UTF-8">
...
<div class="min-h-screen relative overflow-hidden bg-gray-50 flex flex-col items-center justify-center px-4 py-16 md:px-8">
    <!-- Ambient background -->
    <div class="absolute -top-24 -left-24 w-96 h-96 bg-red-100 rounded-full blur-3xl opacity-70 floating-slow"></div>
    <div class="absolute -bottom-24 -right-24 w-96 h-96 bg-purple-100 rounded-full blur-3xl opacity-70 floating-slower"></div>
    ...
    <div class="relative text-center mb-14">
        ...
        <span class="inline-block px-4 py-1 rounded-full text-xs font-bold tracking-widest uppercase text-red-600 bg-red-50 border border-red-100 mb-4">
            Get Started
        </span>
        <h2 class="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
            Which account is <span class="bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-purple-600">right for you?</span>
        </h2>
        <p class="text-gray-600 mt-4 text-lg max-w-lg mx-auto">
            Pick a path below  both take less than five minutes to set up.
        </p>
    </div>

    <!-- Cards Grid -->
    <div class="relative grid md:grid-cols-2 gap-8 max-w-4xl w-full">
        <!-- Personal Account -->
        <div class="group relative bg-white rounded-3xl shadow-sm hover:shadow-2xl border border-gray-100 transition-all duration-300 p-8 pt-10 transform hover:-translate-y-1.5 flex flex-col justify-between overflow-hidden">
            <div class="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-red-500 to-rose-400"></div>
            <span class="absolute top-6 right-6 text-[11px] font-bold uppercase tracking-wide text-emerald-700 bg-emerald-50 border border-emerald-100 rounded-full px-3 py-1">
                Most Popular
            </span>

            <div>
                <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center text-white shadow-md shadow-red-500/20 mb-6">
                    <i data-lucide="user" class="h-7 w-7"></i>
                </div>
                <h3 class="text-2xl font-bold text-gray-900">Personal Account</h3>
                <p class="text-sm text-gray-500 mt-1 mb-6">For individuals and everyday banking.</p>

                <ul class="space-y-3 text-gray-600 mb-8 text-sm">
                    <li class="flex items-center">
                        <i data-lucide="check-circle-2" class="h-4 w-4 text-red-500 mr-2.5 flex-shrink-0"></i>
            ...
            <a href="{{ route('register') }}"
               class="relative inline-flex items-center justify-center w-full bg-gradient-to-r from-red-600 to-rose-500 hover:from-red-700 hover:to-rose-600 text-white rounded-xl py-3.5 font-bold shadow-lg shadow-red-600/20 transition-all duration-300">
        ...
        <!-- Corporate Account -->
        <div class="group relative bg-white rounded-3xl shadow-sm hover:shadow-2xl border border-gray-100 transition-all duration-300 p-8 pt-10 transform hover:-translate-y-1.5 flex flex-col justify-between overflow-hidden">
            <div class="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-purple-500 to-indigo-400"></div>
            <span class="absolute top-6 right-6 text-[11px] font-bold uppercase tracking-wide text-purple-700 bg-purple-50 border border-purple-100 rounded-full px-3 py-1">
                For Business
            </span>

            <div>
                <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white shadow-md shadow-purple-500/20 mb-6">
                    <i data-lucide="building-2" class="h-7 w-7"></i>
                </div>
                <h3 class="text-2xl font-bold text-gray-900">Corporate Account</h3>
                <p class="text-sm text-gray-500 mt-1 mb-6">For registered businesses and organizations.</p>

                <ul class="space-y-3 text-gray-600 mb-8 text-sm">
                    <li class="flex items-center">
                        <i data-lucide="check-circle-2" class="h-4 w-4 text-purple-500 mr-2.5 flex-shrink-0"></i>
                        Business Banking
                    </li>
                    <li class="flex items-center">
                        <i data-lucide="check-circle-2" class="h-4 w-4 text-purple-500 mr-2.5 flex-shrink-0"></i>
                    ...
                    <li class="flex items-center">
                        <i data-lucide="check-circle-2" class="h-4 w-4 text-purple-500 mr-2.5 flex-shrink-0"></i>
                        Corporate Cards & Relationship Manager
                    </li>
                </ul>
            </div>

            <a href="{{ route('register.corporate') }}"
               class="relative inline-flex items-center justify-center w-full bg-gradient-to-r from-purple-600 to-indigo-500 hover:from-purple-700 hover:to-indigo-600 text-white rounded-xl py-3.5 font-bold shadow-lg shadow-purple-600/20 transition-all duration-300">
