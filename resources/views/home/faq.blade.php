  ...
  <div class="bk-wrap" style="max-width:820px">
    ...
    <div class="bk-accordion">
      <div class="bk-acc-item sr">
        <button class="bk-acc-btn">What is Unova Saver Bank Corporation? <i class="ri-add-line"></i></button>
        <div class="bk-acc-body">
          <p>Unova Saver Bank Corporation is a full-service financial institution offering personal and business banking, loans, credit cards, and investment services. We are committed to providing secure, convenient, and innovative banking solutions to help our customers achieve their financial goals.</p>
        </div>
      </div>
      <div class="bk-acc-item sr">
      ...
      <div class="bk-acc-item sr">
        <button class="bk-acc-btn">Is my money safe with unova saver Bank? <i class="ri-add-line"></i></button>
        <div class="bk-acc-body">
