  ...
  <div class="bk-wrap">
    <div class="bk-footer-grid">
      ...
      <div class="bk-footer-about">
        <a href="/"><img src="our-logo.png" alt="unova saver Bank" class="bk-footer-logo"></a>
        <p>Unova Saver Bank Corporation is dedicated to innovating, simplifying, and humanizing digital banking for customers around the world.</p>
      ...
      <div class="bk-footer-col">
        ...
        <div class="bk-footer-contact-item">
          ...
          <div><small>Email</small><p><a href="mailto:support@unovasaverbc.com">support@unovasaverbc.com</a></p></div>
        </div>
      </div>
    </div>
  </div>
  <div class="bk-footer-bottom">
    <div class="bk-wrap">
      <div class="bk-footer-bottom-inner">
        <p>&copy;  2026 Unova Saver Bank Corporation. All rights reserved.</p>
