...
<section class="bk-page-section">
  <div class="bk-wrap">
    <div class="bk-text-page sr">
      ...
      <p>By accessing and using the services of Unova Saver Bank Corporation ("the Bank"), you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you should not use our services.</p>
      ...
      <h2>12. Contact</h2>
      <p>If you have any questions about these Terms, please contact us at <a href="{{ url('contact') }}" style="color:var(--blue)">our contact page</a> or email us at support@unovasaverbc.com.</p>
