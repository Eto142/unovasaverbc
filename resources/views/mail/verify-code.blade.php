...
@section('title', 'Account Verification — Unova Saver Bank Corporation')
...
<p style="margin:0 0 26px;color:#6b7280;font-size:14px;line-height:1.6">
  Thank you for registering with Unova Saver Bank Corporation. Your registration is successful and
