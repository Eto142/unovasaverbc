...
<head>
        ...
        <title>Create Account — Unova Saver Bank Corporation</title>
        ...
        <div class="container">
            <div class="pb-3 row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    <a href="{{ url('/') }}"><img src="{{ asset('logo1.png') }}" alt="unova saver Bank" class="mb-3 img-fluid auth__logo" style="max-height:60px;"></a>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url('/register-user') }}">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-4 mb-0"><small class="mr-2 text-dark">&copy; {{ date('Y') }} &nbsp; Unova Saver Bank Corporation &nbsp; All Rights Reserved.</small>
                                        </p>
                                    </div>
                                </div>
                                <!--end row-->
